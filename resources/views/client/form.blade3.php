...
<div class="container text-center">
    <form class="form-signin was-validated text-center" action="{{ route('client.composse') }}" method="POST">
        ...
        <input type="text" name="from_lng" id="from_lng">
        <input type="text" name="to_lat" id="to_lat">
        <input type="text" name="to_lng" id="to_lng">
        ...
        <div class="form-group">
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" placeholder="Enter your address" id="from_address" name="from_address" required readonly>
                <div class="invalid-feedback">Please fill out this field.</div>
                <div id="source"></div>
        ...
        <div class="form-group">
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" placeholder="Enter your Distination" id="to_address" name="to_address" readonly>
                <div class="invalid-feedback">Please fill out this field.</div>
                <div id="dist"></div>
            </div>
        </div>
...
@section('js')
<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyANYVpeOpsNN4DqdKR4AKAyd03IQ3_9PvU"></script>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#confirmDist").click(function() {
            $("#dist").slideToggle();
            var lp1 = new locationPicker('dist', {
